...
class GF_Instamojo extends GFPaymentAddOn
{
     ...
     */
    protected $_slug = 'integrate-instamojo-to-gravity-forms';

    /**
     * @var string Relative path to the plugin from the plugins's folder. Example "gravityforms/gravityforms.php"
     */
    protected $_path = 'integrate-instamojo-to-gravity-forms/instamojo.php';
     ...
     */
    protected $_title = 'Integrate Instamojo to Gravity Forms';
